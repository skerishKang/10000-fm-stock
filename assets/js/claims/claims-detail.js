...
function renderClaimDetail(claimId, data) {
  var c = document.getElementById("claim-detail-container");
  if (!c) return;
...
function renderEvidence(claim) {
  ...
  return "<div class=\"detail-section evidence\"><h3>Evidence " + String.fromCharCode(38) + " Logic</h3><p>" + claim.evidence + "</p></div>";
}
